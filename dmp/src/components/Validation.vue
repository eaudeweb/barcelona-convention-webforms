    ...
    openArtilce(article, tab) {
    	...
    	switch (tab) {
    		...
    		case 'Part II: DUMPING AT SEA PERMITS AND QUANTITIES':
    			tabIndex = 1;
    			break;
    		case 'Part III: QUANTITIES OF WASTES OR OTHER MATTER FOR EACH DUMP SITE AND COORDINATES FOR DUMP SITES':
    			tabIndex = 2;
    			break;
    		case 'Part IV: MONITORING':
    			tabIndex = 3;
    			break;
        case 'Part V: PLACEMENT (Dumping Protocol, Article 3.4.b)':
          tabIndex = 4;
          break;
    		default:
    			// statements_def
