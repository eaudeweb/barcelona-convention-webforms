  ...
  tab_2: {
    ...
    data: {
      table_1: {
        ...
        table_note: 'Tables 2 to 5 harmonized to follow the Revised Electronic Reporting Format of the London Convention and its Protocol on Dumping (LC 33/15 Annex 5).<br>Important: If countries have ratified both the 1976 Protocol and the 1995 Protocol, the report should include information on the 1995 Protocol only.',
