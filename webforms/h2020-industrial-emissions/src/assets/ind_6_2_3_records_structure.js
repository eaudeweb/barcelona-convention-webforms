...
const ind_6_2_3_records_structure = (adminRegions, data) => {
  let sector = null
  return {
    ...
    PAH: {
      name: 'PAH',
      type: 'number',
      selected: data && data.PAH || null,
      label: 'Total quantity of released polycyclic aromatic hydrocarbons',
      tooltip: 'Total PAH load as of the reference year (measured in kg per year)',
      get validation() {
...
export default ind_6_2_3_records_structure
