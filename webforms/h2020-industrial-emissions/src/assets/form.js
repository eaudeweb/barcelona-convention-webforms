    ...
    tab_2: {
      ...
      form_fields: {
        ...
        ind_6_2_3_records: {
          ...
          fields: [ind_6_2_3_records_structure(formData.adminRegions)]
        },
        ind_6_2_4_records: {
          ...
          fields: [ind_6_2_4_records_structure(formData.adminRegions)]
        }
      }
    },
    tab_3: {
      ...
      form_fields: {
        ind_6_3_1_records: {
          ...
          fields: [ind_6_3_1_records_structure(formData.adminRegions)]
        },
        ind_6_3_2_records: {
          ...
          fields: [ind_6_3_2_records_structure(formData.adminRegions)]
        }
      }
    },
    tab_4: {
      ...
      form_fields: {
        ind_6_4_1_records: {
          ...
          fields: [ind_6_4_1_records_structure(formData.adminRegions)]
        },
        ind_6_4_2_records: {
          ...
          fields: [ind_6_4_2_records_structure(formData.adminRegions)]
        },
        ind_6_4_3_records: {
          description: 'Number of eliminated hotspots identified in the updated NAPs relative to the 2001 and 2015 baselines',
          fields: [ind_6_4_3_records_structure(formData.adminRegions)]
        }
      }
    }
  }
