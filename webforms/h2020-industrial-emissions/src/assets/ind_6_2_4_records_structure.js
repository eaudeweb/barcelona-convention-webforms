...
const ind_6_2_4_records_structure = (adminRegions, data) => {
  let sector = null
  return {
    ...
    VOC: {
      name: 'VOC',
      type: 'number',
      selected: data && data.VOC || null,
      label: 'Total quantity of released Volatile Organic Compounds',
      tooltip: 'Total VOC load as of the reference year (measured in kg per year)',
      get validation() {
...
export default ind_6_2_4_records_structure
