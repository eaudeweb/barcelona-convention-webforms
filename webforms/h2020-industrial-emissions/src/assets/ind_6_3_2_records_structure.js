...
const ind_6_3_2_records_structure = (adminRegions, data) => {
  return {
    ...
    generatedHW: {
      name: 'generatedHW',
        type: 'number',
        selected: data && data.generatedHW || null,
    ...
    importedHW: {
      name: 'importedHW',
        type: 'number',
        selected: data && data.importedHW || null,
    ...
    exportedHW: {
      name: 'exportedHW',
        type: 'number',
        selected: data && data.exportedHW || null,
    ...
    stokpiledHW: {
      name: 'stokpiledHW',
        type: 'number',
        selected: data && data.stokpiledHW || null,
    ...
    dipositedHW: {
      name: 'dipositedHW',
        type: 'number',
        selected: data && data.dipositedHW || null,
    ...
    dispVsGenHW: {
      name: 'dispVsGenHW',
        type: 'number',
        selected: data && data.dispVsGenHW || null,
