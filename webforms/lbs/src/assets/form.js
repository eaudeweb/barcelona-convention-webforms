  ...
  tab_2: {
    ...
    data: {
      question: {
        ...
        options_description: ['If your answer is “Yes”, no need to fill out this table', 'If your answer is “No”, please kindly submit the data via NBB (link to nbb envelope) and the NBB Country Report as a supporting document'],
      },
      eprtr_question: {
        label: 'Data submitted via e-PRTR for the current biennium',
        info: 'Please, tick the box that applies',
        selected: null,
        options: [{
          value: true,
        ...
        options_description: ['If your answer is "Yes", no need to fill out this table and please provide the e-PRTR link', 'If your answer is "No", please kindly submit the data via NBB (link to nbb envelope)'],
      },
      eprtr_envelope_link: {
        label: 'e-PRTR envelope link',
        info: 'Link of the envelope where the e-PRTR data was submitted.',
        type: 'text',
        name: 'eprtr_envelope_link',
        value: '',
      },
      nbb_envelope_link: {
        label: 'NBB envelope link',
        info: 'Link of the NBB envelope where the data was submitted.',
        type: 'text',
        name: 'nbb_envelope_link',
        value: '',
      },
    ...
    data: {
      ...
      articles: [{
        ...
        article_items: [{
          ...
          additional_description: "Table harmonized to follow the Electronic Reporting System of the Stockholm Convention (Third Reporting) (SC-6/21). In particular: (1) Section II. Article 3: Measures to reduce or eliminate releases from intentional production and use (Question 5), (2) Section IV. Article 5: Measures to reduce or eliminate releases from unintentional production (Question 14) and (3) Section V. Article 6: Measures to reduce or eliminate releases from stockpiles and wastes (Questions 19 and 20).",
          collection_id: 4010,
