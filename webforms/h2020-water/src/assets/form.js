    ...
    tab_1: {
      ...
      form_fields: {
        ind_3_1_1_records: {
          ...
          fields: [ind_3_1_1_records_structure(formData)]
        },
        ind_3_1_2_records: {
        ...
        ind_3_2_2_records: {
          ...
          fields: [ind_3_2_2_records_structure(formData)]
        }
      }
    },
    tab_2: {
      ...
      form_fields: {
        ...
        ind_4_3_records: {
          ...
          fields: [ind_4_3_records_structure(formData)]
        }
      }
    },
    tab_3: {
      ...
      form_fields: {
        ind_5_1_1_records: {
          ...
          fields: [ind_5_1_1_records_structure(formData)]
        },
        ind_5_1_2_records: {
          description: 'Nutrient concentrations in transitional, coastal and marine waters (Parameters)',
          fields: [ind_5_1_2_records_structure(formData)]
        },
        ind_5_2_records: {
          description: 'Bathing Water Quality',
          fields: [ind_5_2_records_structure(formData)]
        }
      }
    }
  }
