{
	"BC_PEP": {
		...
		"contacting_party": {
			"partyname": null,
			"rep_period_from": "51512-02-04",
			"rep_period_to": "0515-05-12",
			"institution_name": "5wras",
			"officer_name": "gasgsag",
			"mailing_address": "fssa",
			"tel": "gasgas",
			"fax": "gasgas",
			"email": "gasgasg@saga",
			"contact_point": "sgasg",
			"instituion_full_name": "sagsag",
			"national_mailing_address": "asgasg",
			"national_tel": null,
			"national_fax": null,
			"national_email": null,
		...
		"measuresdata": {
			"Row": [
				...
				},
				{
					...
					"changes": null,
					"difficulties": null,
					"difficulties_comments": "gasgas",
					"status": 1,
					"status_comments": "gsagas"
				},
				{
			...
			"Row": [
				{
					...
					"ship_category": 2,
					"ship_flag": "gasgas",
					"offshore_name_id": "gsagas",
					"installation_type": 1,
					"oil_name_id": "sgasg",
					"oil_type": 2,
					"actions": true,
					"actions_taken": "sgassga"
				},
				{
					"collection_id": null,
					"parent_collection_id": null,
